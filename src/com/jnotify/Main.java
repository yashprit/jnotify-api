...
public class Main {
	...
	public static void main(String[] args) {
		...
		new NotifyWindow(NotifyType.DEFAULT_NOTIFICATION, "Le Lorem Ipsum est simplement du faux texte employé",
				NotifyWindow.NORMAL_DELAY, NPosition.TOP_RIGHT);

		new NotifyWindow(NotifyType.SUCCESS_NOTIFICATION, "Le Lorem Ipsum est simplement du faux texte employé",
				NotifyWindow.NORMAL_DELAY, NPosition.TOP_RIGHT);
	}
}
